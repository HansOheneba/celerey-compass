...
export function Section3({ register, errors }: Props) {
  return (
    <div className="space-y-6">
      ...
      <div>
        <Label htmlFor="compassGoal">
          What do you hope Compass will do for you?
        </Label>
        <p className="mb-1 mt-0.5 text-xs text-[#9ca3af]">
      ...
      <div>
        <Label htmlFor="futureWorries">
          Is there anything about your future you&apos;re genuinely unsure or
          worried about?
          <span className="ml-1 font-normal text-[#9ca3af]">Optional</span>
        </Label>
        <p className="mb-1 mt-0.5 text-xs text-[#9ca3af]">
          The students who answer this honestly get the most out of the
          programme.
        </p>
        <Textarea
          id="futureWorries"
